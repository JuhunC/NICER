			...
			<div class="row align-items-center ftco-vh-75">
				<div class="col-md-7">
					<h1 class="ftco-heading mb-3" data-aos="fade-up"
						data-aos-delay="500">GAMMA</h1>
					<h2 class="h5 ftco-subheading mb-5" data-aos="fade-up"
						data-aos-delay="600">
						Generalized Analysis of Molecular variance for Mixed model
						Analysis <a href="http://genetics.cs.ucla.edu/GAMMA/"
							target="_blank">GAMMA</a> is a method that can simultaneously
						analyze many phenotypes as well as correct for population
						structure. (Click the bold text if you want to use the program
						manually.)
					</h2>
				</div>
			</div>
	...
	<div class="container">
		<div class="col-md-7">
			...
			<h2 data-aos="fade-up" data-aos-delay="600">For analysis using
				GAMMA, you need to upload SNP file, phenotype file and input the
				number of SNPs.</h2>
				...
				<div class="container">
					<div class="row block-9">
						<div class="col-md-6 pr-md-5">
							<form action="GAMMAServlet" method="post"
