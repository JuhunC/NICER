			...
			<div class="row align-items-center ftco-vh-75">
				<div class="col-md-7">
					<h1 class="ftco-heading mb-3" data-aos="fade-up"
						data-aos-delay="500">Manhattan</h1>
					<h2 class="h5 ftco-subheading mb-5" data-aos="fade-up"
						data-aos-delay="600">
						<a href="http://genetics.cs.ucla.edu/multiTrans/" target="_blank">Manhattan</a>
						is drawing tool.
					</h2>
				</div>
			</div>
	...
	<div class="container">
		<div class="col-md-7">
			...
			<h2 data-aos="fade-up" data-aos-delay="600">For analysis using
				Manhattan, you need to upload P-value file</h2>
				...
				<div class="container">
					<div class="row block-9">
						<div class="col-md-6 pr-md-5">
							<form name='manh' action="Manhattan" method="post"
